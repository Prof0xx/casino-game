...
// var jsonLog = require('jsonlogs'); // Temporarily disabled for testing
var paypalPayment = express.Router()

var { AUTH_USER, PAYPAL_MODE, PAYPAL_CLIENT_ID, PAYPAL_CLIENT_SECRET } = require('../var/constants')
...
paypal.configure({
  ...
  // 'log_string': jsonLog(AUTH_USER) // Temporarily disabled for testing
})
